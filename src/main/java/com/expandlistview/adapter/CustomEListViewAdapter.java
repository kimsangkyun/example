...
@SuppressLint("ResourceAsColor") public class CustomEListViewAdapter extends BaseExpandableListAdapter {
    ...
    private Resources resourecs = null;
    public CustomEListViewAdapter(Context context, int resourceId,
                                  ArrayList<TitleNameItem> goodsItemList,int gubun) {
        this.context = context;
        this.gubun = gubun;
        this.goodsItemList = goodsItemList;
        resourecs = context.getResources();
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		try{
			...
			if(convertView == null){
				...
				convertView = inflater.inflate(R.layout.leftslidechildmenu, null);
			}

			TextView childMenuText = (TextView)convertView.findViewById(R.id.childTxt);
			childMenuText.setText(item);
		}catch(Exception e){
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
      ...
      LayoutInflater mInflater = (LayoutInflater) context
        ...
        if(convertView == null) {
            ...
            convertView.setTag(viewHolderNavi);
        }else{
